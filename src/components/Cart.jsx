          ...
          <div className='flex items-center leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4'>
            ...
            <div className='flex gap-4 mt-2 items-center'>
              ...
              <div className='flex items-center border-1 border-color rounded'>
                ...
                <p className='p-2 dark:border-gray-600 border-color text-green-600'>0</p>
                <p className='p-2 border-l-1 dark:border-gray-600 border-color text-red-600'><AiOutlinePlus/></p>
              </div>
            </div>
            </div>
          </div>
