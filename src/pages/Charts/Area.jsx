...
const Area = () => {
  ...
  return (
    <div className='m-4 md:m-10 mt-42 p-10 bg-white dark:bg-secondary-dark-bg rounded-3xl'>
      <Header category="Chart" title="Inflation Rate in Percentage"/>
      <div className='w-full'>
        <ChartComponent id='area-chart' height="420px" primaryXAxis={areaPrimaryXAxis} primaryYAxis={areaPrimaryYAxis} chartArea={{ border: {width: 0}}} tooltip={{ enable: true }} background={currentMode === 'Dark' ? '#33373E' : "#fff"} legendSettings={{ textStyle:{ color: currentMode === 'Dark' ? 'white' : "black" }}}>
